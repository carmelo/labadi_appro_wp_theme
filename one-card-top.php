<?php
/**
 * ONE Card with its parents attributes
 * lists all the images in a cards gallery
 *
 * @package WordPress
 * @subpackage labadi_appro one-card-top.php
...
//echo ('<p>' . get_the_ID() . ' - ' . $total .'</p>');
	...
	<div class="project-card columns small-12 medium-6 medium-clear-2"> 
        <?php echo ('<!--  -' . count($attachments)  . ' -->'); ?>
            <a href="<?php echo( get_permalink( wp_get_post_parent_id(get_the_ID() ) ) ); ?>" class="fancybox" data-fancybox-group="images_gallery">
                <figure class="img-hover">
                    ...
                    <div class="cover">
						<h4><?php echo (get_the_title( wp_get_post_parent_id(get_the_ID() ) ) ); ?></h4>
					</div>
                </figure>
            </a>
</div>   
