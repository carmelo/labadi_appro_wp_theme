...
//=============================================== Project Filtering ===============================================
	function projectFilterInit() {
		jQuery('#filterNav a').click(function(){
			...
			var _dataList	= jQuery('#filterNav').attr('data-list'); // Terms list
			var _dataTerm	= jQuery(this).attr('data-term');
			...
			// Check if there is any data-list to show term description
			if( _dataTerm!=0 ){
				jQuery.map( window.partnersTerms, function(obj) {
					if(obj.term_id == _dataTerm){
						jQuery(".term-description").html('').fadeOut(0).html(obj.description).fadeIn(350);
					}
				});
			}else{
				jQuery(".term-description").fadeOut(0).html('');
			}
